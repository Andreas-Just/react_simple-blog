...
const AddPost = (
  { post, isRedirect, inputClearHandler, inputChangeHandler, createPosts }
) => {
  ...
  return (
    <div className='add-post row no-gutters'>
      <h3 className='add-post__title mt-5'>Add post</h3>
      <div className='add-post__form row mt-4 no-gutters'>
        <div className='input-group mb-3'>
          <div className='input-group-prepend'>
            <span className='input-group-text'>Title post</span>
          </div>
          <input
            className='add-post__input form-control'
            name='title'
            value={post.title}
            type='text'

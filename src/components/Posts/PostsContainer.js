...
import {
  loadPosts, toggleIsFetching, deletePosts,
  saveId, transferDataForEditing
} from '../../store/actions';
...
class PostsContainer extends Component {
  ...
  render() {
    const {
      posts, isFetching, deletePosts,
      isReload, loadPosts, toggleIsFetching,
      deleteId, saveId, transferDataForEditing
    } = this.props;
